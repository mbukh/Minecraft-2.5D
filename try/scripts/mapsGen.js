...
const mapData = [
    [
        ...
        [2, 2, 3, 4, 6, 6, 4, 4, 3, 4, 4, 3, 2, 2, 1, 1],
        [2, 3, 3, 4, 8, 8, 8, 8, 4, 8, 5, 4, 3, 2, 2, 1],
        [2, 3, 4, 5, 8, 7, 7, 6, 4, 8, 6, 5, 4, 3, 2, 1],
        [2, 3, 4, 5, 9, 9, 6, 8, 7, 6, 6, 5, 4, 3, 2, 1],
        [2, 3, 3, 4, 5, 9, 6, 6, 6, 6, 5, 4, 3, 2, 2, 2],
        [2, 2, 3, 3, 4, 5, 6, 5, 5, 5, 4, 4, 3, 2, 2, 2],
