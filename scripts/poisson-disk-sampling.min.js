                ...
                function (require, module, exports) {
                    module.exports = function moore(range, dimensions) {
                        ...
                        for (var i = 0; i < length; i++) {
                            var neighbor = (neighbors[i] = new Array(
                                dimensions
                            ));
                            ...
                            for (
                                ...
                                neighbor[dimension - 1] =
                                    value / Math.pow(size, dimension - 1) -
                                    range;
                                index -= value;
                            }
                        }
            ...
            2: [
                function (require, module, exports) {
                    ...
                    function FixedDensityPDS(options, rng) {
                        ...
                        this.maxDistance =
                            options.maxDistance || options.minDistance * 2;
                        this.maxTries = Math.ceil(
                            Math.max(1, options.tries || 30)
                        );
                        ...
                        for (var i = 0; i < this.dimension; i++) {
                            this.gridShape.push(
                                Math.ceil(this.shape[i] / this.cellSize)
                            );
                        }
                    ...
                    FixedDensityPDS.prototype.addPoint = function (point) {
                        ...
                        if (point.length === this.dimension) {
                            for (
                                dimension = 0;
                                dimension < this.dimension && valid;
                                dimension++
                            ) {
                                valid =
                                    point[dimension] >= 0 &&
                                    point[dimension] < this.shape[dimension];
                            }
                        } else {
                            valid = false;
                        }
                    ...
                    FixedDensityPDS.prototype.directAddPoint = function (
                        point
                    ) {
                        ...
                        this.grid.data[internalArrayIndex] =
                            this.samplePoints.length;
                        return point;
                    };
                    FixedDensityPDS.prototype.inNeighbourhood = function (
                        point
                    ) {
                        ...
                        for (
                            ...
                            for (
                                ...
                                currentDimensionValue =
                                    ((point[dimension] / this.cellSize) | 0) +
                                    this.neighbourhood[neighbourIndex][
                                        dimension
                                    ];
                                if (
                                    currentDimensionValue < 0 ||
                                    currentDimensionValue >=
                                        this.gridShape[dimension]
                                ) {
                                    internalArrayIndex = -1;
                                    break;
                                }
                                internalArrayIndex +=
                                    currentDimensionValue * stride[dimension];
                            }
                            if (
                                internalArrayIndex !== -1 &&
                                ...
                                existingPoint =
                                    this.samplePoints[
                                        this.grid.data[internalArrayIndex] - 1
                                    ];
                                if (
                    ...
                    FixedDensityPDS.prototype.getAllPointsWithDistance =
                        function () {
                            throw new Error(
            ...
            3: [
                function (require, module, exports) {
                    ...
                    function VariableDensityPDS(options, rng) {
                        ...
                        this.cellSize =
                            this.maxDistance / Math.sqrt(this.dimension);
                        this.neighbourhood = getNeighbourhood(this.dimension);
                        this.currentPoint = null;
                    ...
                    VariableDensityPDS.prototype.directAddPoint = function (
                        point
                    ) {
                        var internalArrayIndex = 0,
                            stride = this.grid.stride,
                    ...
                    VariableDensityPDS.prototype.inNeighbourhood = function (
                        point
                    ) {
                        var dimensionNumber = this.dimension,
                            stride = this.grid.stride,
                        ...
                        for (
                            ...
                            if (
                                ...
                                for (
                                    var i = 0;
                                    i <
                                    this.grid.data[internalArrayIndex].length;
                                    i++
                                ) {
                                    existingPoint =
                                        this.samplePoints[
                                    ...
                                    var dist =
                                        minDistance +
                                        (maxDistance - minDistance) * this.bias;
                                    if (
                                        euclideanDistance(
                                            point,
                                            existingPoint
                    ...
                    VariableDensityPDS.prototype.next = function () {
                        ...
                        while (this.processList.length > 0) {
                            if (this.currentPoint === null) {
                                ...
                                this.currentPoint =
                                    this.samplePoints[sampleIndex];
                                this.currentDistance =
                                    this.sampleDistance[sampleIndex];
                            }
                            currentPoint = this.currentPoint;
                    ...
                    VariableDensityPDS.prototype.getAllPointsWithDistance =
                        function () {
                ...
                function (require, module, exports) {
                    ...
                    function getNeighbourhoodMemoized(dimensionNumber) {
                        if (!neighbourhoodCache[dimensionNumber]) {
                            neighbourhoodCache[dimensionNumber] =
                                getNeighbourhood(dimensionNumber);
                        }
            ...
            5: [
                function (require, module, exports) {
                    ...
                    function PoissonDiskSampling(options, rng) {
                        this.shape = options.shape;
                        if (typeof options.distanceFunction === "function") {
                            this.implementation = new VariableDensityPDS(
                                options,
                                rng
                            );
                        } else {
                            this.implementation = new FixedDensityPDS(
                                options,
                                rng
                            );
                        }
                    ...
                    PoissonDiskSampling.prototype.getAllPointsWithDistance =
                        function () {
                ...
                {
                    "./implementations/fixed-density": 2,
                    "./implementations/variable-density": 3,
                },
            ],
            6: [
                function (require, module, exports) {
                ...
                function (require, module, exports) {
                    ...
                    function tinyNDArrayOfInteger(gridShape) {
                        ...
                        for (
                            ...
                            totalLength =
                                totalLength * gridShape[dimension - 1];
                        }
                        return {
                            stride: stride,
                    ...
                    function tinyNDArrayOfArray(gridShape) {
                        ...
                        return { stride: stride, data: data };
                    }
                    module.exports = {
